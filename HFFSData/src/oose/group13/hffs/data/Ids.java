...
public class Ids {
	...
	/**
	 * Get the table id (should always be 1)
	 * @return the id
	 */
	...
	/**
	 * Set method so hibernate works, we always want the row to be 1
	 * @param i a long so hibernate compiles, does not do anything
	 */

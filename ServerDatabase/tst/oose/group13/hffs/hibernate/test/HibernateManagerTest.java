...
public class HibernateManagerTest {
	...
	public void getForSale(){
		Item i1=new Item("Harry Potter1","ShortD","LongD",ItemType.BOOKS,1,ItemState.AVAILABLE,1,imageInByte);
		...
		i1=new Item("Harry Potter1","ShortD","LongD",ItemType.BOOKS,10,ItemState.AVAILABLE,10,imageInByte);
		manager.insert_record(i1);
	}

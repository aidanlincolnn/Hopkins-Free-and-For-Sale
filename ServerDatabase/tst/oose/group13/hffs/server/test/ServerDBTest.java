...
public class ServerDBTest {
	...
	public void getOffers(){
		...
		Offer o2 = new Offer(101,100,1,"name1",1,3,OfferState.ACCEPTED);
		Offer o3 = new Offer(102,100,1,"name1",1,4,OfferState.OPEN);
		Offer o4 = new Offer(103,100,1,"name1",2,1,OfferState.ACCEPTED);
		Offer o5 = new Offer(104,100,1,"name1",2,1,OfferState.OPEN);
		Offer o6 = new Offer(105,100,1,"name1",2,1,OfferState.OPEN);
		...
		u = getOffers.getUser();
		assertEquals("Check Sent",3,u.getBuyOffers().size());
		assertEquals("Check received",3,u.getSellOffers().size());
	...
	public void addItem(){
		...
		assertEquals("check the state",ItemState.AVAILABLE,manager.getItem(1).getmAvailability());
		Item i2 = new Item("item","short","long",ItemType.BOOKS,1,ItemState.SOLD,1,null);
		items.clear();
		items.add(i2);
		...
		assertEquals("check the state",ItemState.SOLD,manager.getItem(1).getmAvailability());
	...
	public void updateIds(){
		...
		User u = new User(uid,"afowler","Aidan Fowler","afowler6@jhu.edu","password","7088226804");
